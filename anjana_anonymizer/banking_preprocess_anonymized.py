...
# Config
RAW_PATH = "banking-simplified.csv"
ANON_FOLDER = "banking_simplified_anonymized"
OUTPUT_FOLDER = "banking_simplified_anonymized_clean"
...
for filename in os.listdir(ANON_FOLDER):
    ...
    for idx in missing_indices:
        label = raw_df.loc[idx, "y"]
        suppressed = {col: "*" for col in all_columns if col not in ["index", "y"]}
